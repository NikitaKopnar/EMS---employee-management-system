...
import { LayoutGridIcon, MenuIcon, UserIcon, XIcon, CalendarIcon, FileTextIcon, DollarSignIcon, SettingsIcon, ChevronRightIcon, LogOut } from 'lucide-react';
const SideBar = () => {
    ...
    const sidebarContent =(
            ...
            <div className='flex-1 px-3 space-y-0.5 overflow-y-auto'>
                {navItems.map((item)=>{
                    ...
                    return (
                        ...
                        <item.icon className={`w-[17px] h-[17px] shrinl-0 ${isActive? "text-indigo-300":"text-slate-400 group-hover:text-slate-300"}`} />
        ...
        <div className='p-3 border-t border-white/6'>
                <button className='flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150' onClick={handleLogout}>
