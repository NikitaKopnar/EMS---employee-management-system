import { AlertCircle, Calendar1Icon, ClockIcon } from 'lucide-react';
...
const AttendenceStats = ({history}) => {
  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
        {stats.map((s)=>(
            <div key={s.label} className='card card-hover -5 sm:p-6 flex items-center gap-4 relative overflow-hidden group'>
