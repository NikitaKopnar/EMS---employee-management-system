...
import {ArrowRightIcon, Calendar1Icon, CalendarIcon, DollarSignIcon, FileTextIcon} from 'lucide-react'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
            {cards.map((card, index)=>{
                ...
                <div>
                    ...
                    <p className='text-sm font-mediumtext-slate-700'>{card.title}</p>
